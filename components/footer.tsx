...
function SocialLink({
  ...
  return (
      <a
          ...
          className="group flex items-center justify-between rounded-2xl border border-rose-200/70 bg-card text-foreground px-4 py-2 text-sm font-medium transition-all duration-300 md:hover:-translate-y-0.5 hover:shadow-md"
      >
...
function SocialCard({
  ...
  logo: typeof logoAlp
  logoAlt: string
  socials: Array<{ label: string; href: string; icon: IconComponent }>
  ...
  return (
      <section
          className={`relative h-auto w-full overflow-hidden rounded-3xl border p-5 shadow-sm transition-all duration-300 md:hover:-translate-y-1 md:hover:shadow-2xl ${cardClassName}`}
      >
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <h3 className="mt-2 font-serif text-2xl text-inherit break-words">{title}</h3>
            {}
            <p className={`mt-3 text-sm leading-relaxed ${variant === 'dark' ? 'text-white/80' : 'text-foreground/80'}`}>
              {description}
            </p>
          </div>
...
export function Footer() {
  return (
      <footer className="relative border-t border-border bg-white px-6 py-16 lg:px-12">
        <div className="mx-auto max-w-7xl">
          {}
          <div className="grid gap-10 content-start lg:grid-cols-3 lg:items-start lg:justify-items-center lg:gap-12">
            ...
            <div className="flex w-full max-w-md flex-col items-center text-center lg:items-start lg:text-left">
              <div className="inline-flex items-center gap-3 rounded-full border border-pink-200/70 bg-white/80 px-4 py-2 shadow-sm backdrop-blur">
                <div className="flex size-11 shrink-0 items-center justify-center rounded-full bg-pink-50">
              ...
              <div className="mt-6 grid w-full gap-3 text-sm text-foreground/75">
                {}
                <a href="#chi-siamo" className="flex items-center justify-between rounded-2xl border border-border bg-card/70 px-4 py-3 transition-all duration-300 md:hover:-translate-y-0.5 hover:border-pink-200 hover:bg-white hover:text-pink-500">
                  <span>Chi siamo</span> <ArrowUpRight className="size-4" />
                </a>
                <a href="#edizione-2026" className="flex items-center justify-between rounded-2xl border border-border bg-card/70 px-4 py-3 transition-all duration-300 md:hover:-translate-y-0.5 hover:border-pink-200 hover:bg-white hover:text-pink-500">
                  <span>Edizione 2026</span> <ArrowUpRight className="size-4" />
                </a>
                <a href="#l-associazione" className="flex items-center justify-between rounded-2xl border border-border bg-card/70 px-4 py-3 transition-all duration-300 md:hover:-translate-y-0.5 hover:border-pink-200 hover:bg-white hover:text-pink-500">
                  <span>ALP</span> <ArrowUpRight className="size-4" />
                </a>
                <a href="#lorenzo" className="flex items-center justify-between rounded-2xl border border-border bg-card/70 px-4 py-3 transition-all duration-300 md:hover:-translate-y-0.5 hover:border-pink-200 hover:bg-white hover:text-pink-500">
                  <span>Lorenzo</span> <ArrowUpRight className="size-4" />
                </a>
                <a href="#contatti" className="flex items-center justify-between rounded-2xl border border-border bg-card/70 px-4 py-3 transition-all duration-300 md:hover:-translate-y-0.5 hover:border-pink-200 hover:bg-white hover:text-pink-500">
                  <span>Contatti</span> <ArrowUpRight className="size-4" />
                </a>
              </div>
            </div>
