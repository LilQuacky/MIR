...
import mir2022 from "@/public/mir2022.png"
import mir2024 from "@/public/mir2024.png"
                  ...
                  <div className="flex flex-col lg:flex-row gap-6 lg:gap-12">
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="space-y-6">
                        ...
                        >
                          <img
                            src={step.number === "2022" ? mir2022.src : mir2024.src}
                            alt={`MIR ${step.number}`}
                            className="w-full max-w-md h-auto object-contain rounded-md shadow-sm transform-gpu transition-transform duration-500 hover:scale-105"
                          />
                        </div>
                      </div>
                    </div>
